...
\subsection{Extensions and Comparisons}
- Similar to robust invariant sets in RMPC (e.g., tightened via
Pontryagin difference).
- For stochastic MPC, consider probabilistic safe sets.
